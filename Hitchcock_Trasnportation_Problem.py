...
from tkinter import ttk, simpledialog, messagebox, filedialog, Button
...
class TableauGUI(tk.Tk):
    def __init__(self, transportation_problem):
        ...
        file_menu.add_command(label='Exit', command=self.confirm_exit) # add 'Exit' method
    ...
    def change_ifs(self):
        self.transportation_problem.reset()
    ...
    def create_legend(self):
        ...
        legend_frame.grid(row=self.transportation_problem.num_supply_nodes + 5,
                        column=0,
                        rowspan=2,
                        columnspan=2,
                        sticky='nsew',
...
class Introduction:
    def __init__(self):
        ...
        self.font = pygame.freetype.SysFont('Arial', 24, bold=True)
        self.font.render_to(self.screen, (self.width // 2 - 100, self.height // 2 - 100), "Introduction", (0, 0, 0))
        
        # Display UCI logo
        self.logo = pygame.image.load('uci_logo.png')
        ...
        # GitHub Link
        self.github_link = "https://github.com/AminAkbariCodes"
...
class Menu:
    def __init__(self):
        ...
        self.buttons = {
            "Start the Algorithm": {"action": self.start_algorithm, "icon": pygame.transform.scale(pygame.image.load('start_button.png'), (64, 64))},
            ...
            for event in pygame.event.get():
                ...
                if event.type == pygame.KEYDOWN:
                    ...
                    if event.key == pygame.K_RIGHT:
                        self.scroll_x = max(self.scroll_x - 15, -600)

            for i, line in enumerate(self.manual):
                font = pygame.font.Font(None, 32)
                text = font.render(line, True, (255, 255, 255))
                self.screen.blit(text, (20 + self.scroll_x, 20 + i*30 + self.scroll_y))
